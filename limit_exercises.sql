...
-- 2 MySQL provides a way to return only unique results from our queries with the keyword DISTINCT. For example, to find all the unique titles 
...
#Answer: Alselm Cappello, Utz Mandell, Bounchung Schreiter, Baocai Kushner, Petter Stroustrup.
 */
...
# Answer: Employee names are Pranay Narwekar, Marjo Farrow, Ennio Karcich, Dine Lubachevsky, and Ipke Fontan.
#Answer: Limit gives you the amount of pages at a time and offset is where the pages will start counting. Keep in mind Sql starts counting at 1 and not 0.
SELECT *
FROM employees
WHERE hire_date LIKE '199%'
	AND birth_date LIKE '%12-25'
